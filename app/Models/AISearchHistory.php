...
class AISearchHistory extends Model
{
    ...
    public function getConversationMessages(): array
    {
        ...
        return $messages->map(function ($message) {
            return [
                ...
                'content_type_label' => $message->content_type_label,
                'query' => $message->query,
                ...
                'content_warning' => $message->content_warning ?? null,
                'media_count' => $message->media_count ?? 0,
                'private_access_info' => $message->private_access_info,
    ...
    public function getContentTypeCounts(): array
    {
        ...
        foreach ([self::CONTENT_TYPE_AI, self::CONTENT_TYPE_COMMENT, self::CONTENT_TYPE_UPLOAD, self::CONTENT_TYPE_SOCIAL, self::CONTENT_TYPE_LANDING_PAGE] as $type) {
