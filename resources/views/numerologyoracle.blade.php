...
<div class="container">
  ...
  <hr />
  <div class="footer">🔐 <strong>All API keys secured on server</strong> — Perplexity: sonar-pro, OpenAI: gpt-4o-mini, DeepSeek: deepseek-chat, Kimi: moonshot-v1-8k, Gemini: gemini-3-flash-preview.</div>
</div>
...
<script>
  ...
  function formatUSD(cost) {
    ...
    if (numCost < 0.0001) return `$${numCost.toFixed(7)}`;
