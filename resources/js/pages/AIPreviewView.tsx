...
interface ConversationMessage {
    ...
    content_type: 'ai' | 'comment' | 'upload';
    query: string;
                                    ...
                                    <div className="space-y-3 mb-2">
                                        <div className="bg-gray-50 rounded-lg p-2">
                                            <div className="flex items-center gap-2">
                                                <button 
                                                    onClick={scrollToTop}
                                                    className="flex-1 px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm flex items-center justify-center gap-2 transition-colors shadow-md hover:shadow-lg"
                                                    title={tooltips?.ai_search_view_scroll_top || "Scroll to top"}
                                                    data-tooltip-id="main-tooltip"
                                                    data-tooltip-content={tooltips?.ai_search_view_scroll_top || "Scroll to the beginning of the conversation"}
                                                >
                                                ...
                                                <button 
                                                    ...
                                                    className="flex-1 px-3 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm flex items-center justify-center gap-2 transition-colors shadow-md hover:shadow-lg"
                                                    title={tooltips?.ai_search_view_scroll_bottom || "Scroll to bottom"}
                                                    data-tooltip-id="main-tooltip"
                                                    data-tooltip-content={tooltips?.ai_search_view_scroll_bottom || "Scroll to the latest message"}
                                                >
                                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
