    ...
    return (
        <>
            ...
            <main className={`relative flex justify-end p-4 min-h-screen overflow-hidden ${
                        ...
                        >
                            <div ref={dragRef} className="space-x-4 z-10 absolute mt-5 cursor-move touch-none">
                                <div className="flex items-center gap-4">
                                    ...
                                    <Link href={route('demodesign')} className="group no-drag">
                                    ...
                                    <Link href={route('login')} className="group no-drag">
                ...
                {isPanelVisible && (
                    <div className={`relative mx-auto bottom-4 z-50 backdrop-blur-sm p-4 rounded-xl border border-white-700 overflow-y-auto shadow-2xl w-full max-w-4xl ${auth.user ? 'mt-4' : 'mt-17'}`}>
                        <button 
                        ...
                        <div className="bg-gray-800/80 border border-gray-700 rounded-lg p-4 space-y-4">
                                            ...
                                            return (
                                                <div className="mt-6 bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                                                        <div className="bg-[#1f2937] p-2 rounded-md border border-gray-700 flex items-center justify-center">
                                                            <p className="text-white font-mono">
                                                                <span className="text-green-400">{brandInput.trim()}</span>.{selectedDomain}
                                                            </p>
                                                        </div>
                                                        <div className="bg-[#1f2937] p-2 rounded-md border border-gray-700 flex items-center justify-center gap-4">
                                                    ...
                                                    {/* FIXED: Show original price and savings when coupon is valid - NO PERCENTAGE */}
                                                    {couponStatus.valid && (
                                                        <div className="flex flex-col sm:flex-row gap-2 mt-4 items-stretch mb-4">
                                                            <div className="flex-1 bg-blue-900/50 p-3 rounded-lg text-center flex flex-col justify-center">
                                                                <p className="text-yellow-300 text-sm font-semibold">
                                                                    {(() => {
                                                                        ...
                                                                        // Calculate savings correctly (original - discounted)
                                                            ...
                                                            <div className="flex-1 bg-green-900/50 p-3 rounded-lg text-center flex flex-col justify-center">
                                                    ...
                                                    {!couponStatus.valid && availabilityStatus.promoPrice > 0 && (
                                                        <div className="bg-blue-900/30 p-3 rounded-lg my-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                                <div className="feature-card bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-700 transition-all duration-700 hover:border-green-400/30 hover:translate-y-[-5px]">
                                ...
                                <div className="feature-card bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-700 transition-all duration-700 hover:border-green-400/30 hover:translate-y-[-5px]" style={{transitionDelay: '0.1s'}}>
                                    <div className="w-12 h-12 rounded-lg bg-green-500/10 flex items-center justify-center text-green-400 text-xl mb-4">
                                ...
                                <div className="feature-card bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-700 transition-all duration-700 hover:border-green-400/30 hover:translate-y-[-5px]" style={{transitionDelay: '0.2s'}}>
                                    <div className="w-12 h-12 rounded-lg bg-green-500/10 flex items-center justify-center text-green-400 text-xl mb-4">
