      ...
      <div className={`w-full bg-white border border-slate-200 rounded-3xl p-4 sm:p-6 shadow-xl transition-all ${className}`}>
        ...
        <div className="relative">
          <textarea
            ...
            placeholder={!maxChars ? "What's on your mind? (No character limit)" : "What's on your mind?"}
            className="w-full text-xl text-slate-800 placeholder-slate-400 focus:outline-none resize-none bg-transparent"
            rows={3}
